...
<div class="advisement">
_EIS_ De bestandsextensie voor vectortiles is vrij in te vullen. Het Media Type type van vectortiles volgens mapbox specificatie moet altijd `application/vnd.mapbox-vector-tile` zijn.
